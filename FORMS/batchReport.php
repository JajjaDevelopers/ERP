...
<form id="batchReportForm" class="regularForm" method="POST" action="batchReportHandler.php">
    ...
    <div style="display: grid;">
        <div style="grid-row: 1; grid-column: 1; padding-top: 50px; margin-bottom: 5px; ">
            ...
            <input type="text" id="batchReportClient" class="longInputField" name="batchReportClient"><br>
        ...
        <div style="grid-row: 1; grid-column: 2;">
            ...
            <input type="text" id="batchReportNumber" class="shortInput" name="batchReportNumber"><br>
            <label for="batchOrderNumber">Order No.:</label>
            <input type="number" id="batchOrderNumber" class="shortInput" name="batchOrderNumber"><br>
    ...
    <div>
        ...
        <div style="display: grid;">
            <table id="batchInputTable" style="width: 300px; grid-row: 1; grid-column: 1;">
                ...
                <tr>
                    <td>INPUT FAQ</td>
                    <td><input type="number" id="inputQty" name="inputQty" class="tableInput"></td>
                </tr>
                <tr>
        ...
        <table id="highGradeReturnsTable">
            ...
            <tr>
                <td id="highGrade1Name">Screen 1800</td>
            ...
            <tr>
                <td id="highGrade2Name">Screen 1700</td>
            ...
            <tr>
                <td id="highGrade3Name">Screen 1500</td>
            ...
            <tr>
                <td id="highGrade4Name">Screen 1200</td>
        ...
        <table id="lowGradeReturnsTable">
            ...
            <tr>
                <td id="lowGrade1Name">Rej-1899</td>
            ...
            <tr>
                <td id="lowGrade2Name">Rej-1599/1299(BHP)</td>
            ...
            <tr>
                <td id="lowGrade3Name">PODS/P-Berry</td>
            ...
            <tr>
                <td id="lowGrade4Name">Sweepings/Spillages</td>
            ...
            <tr>
                <td id="lowGrade5Name">Rej-1199</td>
        ...
        <table id="colorSorterRejectsTable" style="margin-top: 10px;">
            ...
            <tr>
                <td id="blacks18Name" class="batchItemLabel">Black Beans from Screen 1800</td>
            ...
            <tr>
                <td id="blacks17Name" class="batchItemLabel">Black Beans from Screen 1700</td>
            ...
            <tr>
                <td id="blacks15Name" class="batchItemLabel">Black Beans from Screen 1500</td>
            ...
            <tr>
                <td id="blacks12Name" class="batchItemLabel">Black Beans from Screen 1200</td>
        ...
        <table id="wastesTable" style="margin-top: 10px;">
            ...
            <tr>
                <td class="batchItemLabel">Stones</td>
            ...
            <tr>
                <td class="batchItemLabel">Pre-Cleaner</td>
            ...
            <tr>
                <td class="batchItemLabel">Grader Husks</td>
