  ...
  <div class="row">
    <div class="col-md-12 justify-content-center">
      ...
      <div class="form-group">
        ...
        <input type="password" name="pwd" class="form-control" placeholder="Repeat  New Password">
      </div>
       <button type="submit" name="reset-password-submit" class="btn btn-primary btn-lg">Reset Password</button>
      </div>
    </div>
  </div>
  </form>
