...
?>
<?php
$ordersSql = $conn->prepare("SELECT batch_order_input_qty, batch_order_mc, grade_name FROM batch_processing_order
...
$ordersSql->execute();
$ordersSql->bind_result($batch_order_input_qty, $batch_order_mc, $grade_name);
$ordersSql->fetch();
$ordersSql->close();
echo 'Wagwan'
