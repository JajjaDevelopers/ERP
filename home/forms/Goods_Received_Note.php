...
<?php include ("../connection/databaseConn.php"); ?>
  <!-- <div class="container"> -->
    <form action="received.php" class="regularForm" method="POST" style="height: 800px;">
      ...
      <div style="display: grid; width:fit-content; margin-left: 70%;">
          ...
          <input type="text" class="shortInput" id="date" placeholder="MM/DD/YYYY" name="daterecorded" value="" style="grid-column: 2; grid-row: 2">
      ...
      <div style="display: grid; width:fit-content ">
        ...
        <div style="grid-column: 2; grid-row:1; margin: 20px 0px 0px 150px">
          ...
          <input type="text" class="longInputField" id="purpose" placeholder="purpose" name="purpose" value="" style="margin-left: 0px; width:280px">
        </div>
      </div>
      <div style="display: grid; margin-top:30px">
        <div class="">
          <label for="origin" class="form-label">Origin:</label>
          <input type="text" class="longInputField" id="origin" placeholder="district" name="customeraddress" value="" style="width: 150px;">
          ...
          <input type="text" class="longInputField" id="driver" placeholder="driver name" name="drivername" value="" style="margin-left: 10px; width:200px">
        </div>
      </div>
