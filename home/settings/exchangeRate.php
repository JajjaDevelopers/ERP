    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="margin: 20px 0px 30px;">
                ...
                <input type="date" id="date" name="date" class="shortInput" style="width: 150px;" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="number" id="rate" name="rate" class="shortInput" step="1" style="width: 150px; text-align:right" required>
            </div>
