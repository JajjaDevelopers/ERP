...
?>
<?php
$selectedGrnNo = $_GET['grnNo'];
getGrnDetails($selectedGrnNo);
?>
<legend class="formHeading">Goods Received Note</legend>
      ...
      <div style="display: grid; width:fit-content; margin-left: 70%;">
          ...
          <input type="text" class="shortInput" id="grnNo" name="grnNo" value="<?= $grn_no ?>" style="grid-column: 2; grid-row: 1; margin-top: 0px;">
